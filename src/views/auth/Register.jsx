...
//     const {loader,successMessage,errorMessage} = useSelector(state=>state.auth)
    ...
    const inputHandle = (e) => {
        setState({                  //so now setState is setting the state as given in input
            ...state,   //rest data as it is
...
//     },[successMessage,errorMessage])
    ...
    <form onSubmit={submit}>
        ...
        <div className='flex flex-col w-full gap-1 mb-3'>
            ...
            <input  className='px-3 py-2 outline-none border border-slate-400 bg-transparent rounded-md' type="email" name='email' placeholder='Email' id='email' required />
        ...
        <div className='flex items-center w-full gap-3 mb-3'>
            <input className='w-4 h-4 text-blue-600 overflow-hidden bg-gray-200 rounded border-gray-300 focus:ring-blue-400' type="checkbox" name="checkbox" id="checkbox" />
        ...
        {/* <button disabled={loader ? true : false}  className='bg-slate-800 w-full hover:shadow-blue-300/ hover:shadow-lg text-white rounded-md px-7 py-2 mb-3'>
            ...
            <button className='bg-slate-800 w-full hover:shadow-blue-300/ hover:shadow-lg text-white rounded-md px-7 py-2 mb-3'>Signup</button>
